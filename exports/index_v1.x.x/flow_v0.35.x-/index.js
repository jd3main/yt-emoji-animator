...
declare var math: math$MathJsStatic;declare module.exports: typeof math
declare type NoLiteralType<T> = $FlowGen$If<$FlowGen$Assignable<T,number>,number,$FlowGen$If<$FlowGen$Assignable<T,string>,string,$FlowGen$If<$FlowGen$Assignable<T,boolean>,boolean,T>>>;declare var math: typeof npm$namespace$math;

      declare var npm$namespace$math: {|
        FactoryFunctionMap: Class<math$FactoryFunctionMap>,
ParseOptions: Class<math$ParseOptions>,
ParseFunction: Class<math$ParseFunction>,
AccessorNode: Class<math$AccessorNode>,
AccessorNodeCtor: Class<math$AccessorNodeCtor>,
ArrayNode: Class<math$ArrayNode>,
ArrayNodeCtor: Class<math$ArrayNodeCtor>,
AssignmentNode: Class<math$AssignmentNode>,
AssignmentNodeCtor: Class<math$AssignmentNodeCtor>,
BlockNode: Class<math$BlockNode>,
BlockNodeCtor: Class<math$BlockNodeCtor>,
ConditionalNode: Class<math$ConditionalNode>,
ConditionalNodeCtor: Class<math$ConditionalNodeCtor>,
ConstantNode: Class<math$ConstantNode>,
ConstantNodeCtor: Class<math$ConstantNodeCtor>,
FunctionAssignmentNode: Class<math$FunctionAssignmentNode>,
FunctionAssignmentNodeCtor: Class<math$FunctionAssignmentNodeCtor>,
FunctionNode: Class<math$FunctionNode>,
FunctionNodeCtor: Class<math$FunctionNodeCtor>,
IndexNode: Class<math$IndexNode>,
IndexNodeCtor: Class<math$IndexNodeCtor>,
ObjectNode: Class<math$ObjectNode>,
ObjectNodeCtor: Class<math$ObjectNodeCtor>,
OperatorNode: Class<math$OperatorNode>,
OperatorNodeCtor: Class<math$OperatorNodeCtor>,
ParenthesisNode: Class<math$ParenthesisNode>,
ParenthesisNodeCtor: Class<math$ParenthesisNodeCtor>,
RangeNode: Class<math$RangeNode>,
RangeNodeCtor: Class<math$RangeNodeCtor>,
RelationalNode: Class<math$RelationalNode>,
RelationalNodeCtor: Class<math$RelationalNodeCtor>,
SymbolNode: Class<math$SymbolNode>,
SymbolNodeCtor: Class<math$SymbolNodeCtor>,
MathJsStatic: Class<math$MathJsStatic>,
FactoryDependencies: Class<math$FactoryDependencies>,
Matrix: Class<math$Matrix>,
BigNumber: Class<math$BigNumber>,
Fraction: Class<math$Fraction>,
Complex: Class<math$Complex>,
PolarCoordinates: Class<math$PolarCoordinates>,
MathJSON: Class<math$MathJSON>,
Unit: Class<math$Unit>,
CreateUnitOptions: Class<math$CreateUnitOptions>,
SimplifyOptions: Class<math$SimplifyOptions>,
Simplify: Class<math$Simplify>,
UnitDefinition: Class<math$UnitDefinition>,
Index: Class<math$Index>,
EvalFunction: Class<math$EvalFunction>,
MathNodeCommon: Class<math$MathNodeCommon>,
Parser: Class<math$Parser>,
Distribution: Class<math$Distribution>,
FormatOptions: Class<math$FormatOptions>,
Help: Class<math$Help>,
ConfigOptions: Class<math$ConfigOptions>,
MathJsJson: Class<math$MathJsJson>,
MathJsChain: Class<math$MathJsChain>,
ImportOptions: Class<math$ImportOptions>,
ImportObject: Class<math$ImportObject>,
      |}
...
declare type math$FactoryFunction<T> = (scope: any) => T;

declare interface math$FactoryFunctionMap {
[key: string]: math$FactoryFunction<any> | math$FactoryFunctionMap,
} 
 ...
 */
declare interface math$ParseOptions {

/**
 * a set of custom nodes
 */
nodes?: {[key: string]: math$MathNode, ...},
} 
 ...
 *     evaluate, compile
 */
declare interface math$ParseFunction {
 ...
 * @returns A node
 */
(expr: math$MathExpression, options?: math$ParseOptions): math$MathNode,
 ...
 */
(exprs: math$MathExpression[], options?: math$ParseOptions): math$MathNode[],
...
declare type math$AccessorNode = {
type: "AccessorNode",
isAccessorNode: true,
object: math$MathNode,
index: math$IndexNode,
name: string,...
} & math$MathNodeCommon


declare interface math$AccessorNodeCtor {
new (object: math$MathNode, index: math$IndexNode): math$AccessorNode,
} 

declare type math$ArrayNode = {
type: "ArrayNode",
isArrayNode: true,
items: math$MathNode[],...
} & math$MathNodeCommon
...
declare interface math$ArrayNodeCtor {
new (items: math$MathNode[]): math$ArrayNode,
} 

declare type math$AssignmentNode = {
type: "AssignmentNode",
isAssignmentNode: true,
object: math$SymbolNode | math$AccessorNode,
index: math$IndexNode | null,
value: math$MathNode,
name: string,...
} & math$MathNodeCommon


declare interface math$AssignmentNodeCtor {
new (object: math$SymbolNode, value: math$MathNode): math$AssignmentNode,
new (
object: math$SymbolNode | math$AccessorNode,
index: math$IndexNode,
value: math$MathNode): math$AssignmentNode,
} 

declare type math$BlockNode = {
type: "BlockNode",
isBlockNode: true,
blocks: Array<{
node: math$MathNode,
...
declare interface math$BlockNodeCtor {
new (
arr: Array<{
node: math$MathNode,...
} | {
...
declare type math$ConditionalNode = {
type: "ConditionalNode",
isConditionalNode: boolean,
condition: math$MathNode,
trueExpr: math$MathNode,
falseExpr: math$MathNode,...
} & math$MathNodeCommon


declare interface math$ConditionalNodeCtor {
new (
condition: math$MathNode,
trueExpr: math$MathNode,
falseExpr: math$MathNode): math$ConditionalNode,
} 

declare type math$ConstantNode = {
type: "ConstantNode",
isConstantNode: true,
value: any,...
} & math$MathNodeCommon
...
declare interface math$ConstantNodeCtor {
new (constant: number): math$ConstantNode,
} 

declare type math$FunctionAssignmentNode = {
...
declare interface math$FunctionAssignmentNodeCtor {
new (
name: string,
params: string[],
expr: math$MathNode): math$FunctionAssignmentNode,
} 

declare type math$FunctionNode = {
type: "FunctionNode",
isFunctionNode: true,
fn: math$SymbolNode,
args: math$MathNode[],...
...
declare interface math$FunctionNodeCtor {
new (fn: math$MathNode | string, args: math$MathNode[]): math$FunctionNode,
} 

declare type math$IndexNode = {
type: "IndexNode",
isIndexNode: true,
dimensions: math$MathNode[],
dotNotation: boolean,...
} & math$MathNodeCommon


declare interface math$IndexNodeCtor {
new (dimensions: math$MathNode[]): math$IndexNode,
new (dimensions: math$MathNode[], dotNotation: boolean): math$IndexNode,
} 

declare type math$ObjectNode = {
type: "ObjectNode",
isObjectNode: true,
properties: {[key: string]: math$MathNode, ...},...
} & math$MathNodeCommon


declare interface math$ObjectNodeCtor {
new (properties: {[key: string]: math$MathNode, ...}): math$ObjectNode,
} 

declare type math$OperatorNode = {
type: "OperatorNode",
isOperatorNode: true,
op: string,
fn: string,
...
declare interface math$OperatorNodeCtor {
new (
op: string,
fn: string,
args: math$MathNode[],
implicit?: boolean): math$OperatorNode,
} 

declare type math$ParenthesisNode = {
...
declare interface math$ParenthesisNodeCtor {
new (content: math$MathNode): math$ParenthesisNode,
} 

declare type math$RangeNode = {
type: "RangeNode",
isRangeNode: true,
start: math$MathNode,
end: math$MathNode,
step: math$MathNode | null,...
} & math$MathNodeCommon


declare interface math$RangeNodeCtor {
new (start: math$MathNode, end: math$MathNode, step?: math$MathNode): math$RangeNode,
} 

declare type math$RelationalNode = {
type: "RelationalNode",
isRelationalNode: true,
conditionals: string[],
params: math$MathNode[],...
} & math$MathNodeCommon


declare interface math$RelationalNodeCtor {
new (conditionals: string[], params: math$MathNode[]): math$RelationalNode,
} 

declare type math$SymbolNode = {
type: "SymbolNode",
isSymbolNode: true,
name: string,...
} & math$MathNodeCommon
...
declare interface math$SymbolNodeCtor {
new (name: string): math$SymbolNode,
} 

declare type math$MathNode = math$AccessorNode
| math$ArrayNode
| math$AssignmentNode
| math$BlockNode
| math$ConditionalNode
| math$ConstantNode
| math$FunctionAssignmentNode
| math$FunctionNode
| math$IndexNode
| math$ObjectNode
| math$OperatorNode
| math$ParenthesisNode
| math$RangeNode
| math$RelationalNode
| math$SymbolNode;

declare type math$MathJsFunctionName = $Keys<math$MathJsStatic>;

declare type math$MathJsStatic = {
e: number,
pi: number,
i: number,
Infinity: number,
...
SQRT2: number,
tau: number,
AccessorNode: math$AccessorNodeCtor,
ArrayNode: math$ArrayNodeCtor,
AssignmentNode: math$AssignmentNodeCtor,
BlockNode: math$BlockNodeCtor,
ConditionalNode: math$ConditionalNodeCtor,
ConstantNode: math$ConstantNodeCtor,
FunctionAssignmentNode: math$FunctionAssignmentNodeCtor,
FunctionNode: math$FunctionNodeCtor,
IndexNode: math$IndexNodeCtor,
ObjectNode: math$ObjectNodeCtor,
OperatorNode: math$OperatorNodeCtor,
ParenthesisNode: math$ParenthesisNodeCtor,
RangeNode: math$RangeNodeCtor,
RelationalNode: math$RelationalNodeCtor,
SymbolNode: math$SymbolNodeCtor,
 ...
 * @see https: /* NO PRINT IMPLEMENTED: JSDocNameReference */ any ://github.com/josdejong/mathjs/issues/2019
 */
uninitialized: any,
version: string,
...
typed: (
name: string,
signatures: {[key: string]: (...args: any[]) => any, ...}) => (...args: any[]) => any,
 ...
 */
createUnit(
units: {[key: string]: string | math$UnitDefinition, ...},
options?: math$CreateUnitOptions): math$Unit,
 ...
 */
divide(x: math$Unit, y: math$Unit): math$Unit | number,
divide(x: math$Unit, y: number): math$Unit,
...
| math$Matrix>(
x: T,
base?: number | math$BigNumber | math$Complex): NoLiteralType<T>,
 ...
 * @see http: /* NO PRINT IMPLEMENTED: JSDocNameReference */ any ://en.wikipedia.org/wiki/Modulo_operation.
 * @param x Dividend
 * @param y Divisor
 ...
 * @returns Multiplication of x and y
 */
multiply<T: math$Matrix | math$MathArray>(x: T, y: math$MathType): T,
...
| math$Matrix>(
x: T,
n?: number | math$BigNumber | math$MathArray): NoLiteralType<T>,
...
subtract(x: math$Unit, y: math$Unit): math$Unit,
 ...
 */
bitAnd<T: number | math$BigNumber | math$MathArray | math$Matrix>(
x: T,
y: number | math$BigNumber | math$MathArray | math$Matrix): NoLiteralType<T>,
 ...
 */
bitXor<T: number | math$BigNumber | math$MathArray | math$Matrix>(
x: T,
y: number | math$BigNumber | math$MathArray | math$Matrix): NoLiteralType<T>,
 ...
 */
leftShift<T: number | math$BigNumber | math$MathArray | math$Matrix>(
x: T,
y: number | math$BigNumber): NoLiteralType<T>,
 ...
 */
rightArithShift<T: number | math$BigNumber | math$MathArray | math$Matrix>(
x: T,
y: number | math$BigNumber): NoLiteralType<T>,
 ...
 */
rightLogShift<T: number | math$MathArray | math$Matrix>(x: T, y: number): NoLiteralType<T>,
 ...
 */
composition<T: number | math$BigNumber>(n: T, k: number | math$BigNumber): NoLiteralType<T>,
 ...
 * @returns S(n,k)
 */
stirlingS2<T: number | math$BigNumber>(n: T, k: number | math$BigNumber): NoLiteralType<T>,
 ...
 */
apply<T: math$MathArray | math$Matrix>(
array: T,
dim: number,
callback: (array: math$MathArray | math$Matrix) => number): T,
 ...
 */
concat(
...args: Array<math$MathArray | math$Matrix | number | math$BigNumber>): math$MathArray | math$Matrix,
 ...
 * @returns A matrix with ones on the diagonal
 */
identity(m: number, n: number, format?: string): math$Matrix | math$MathArray | number,
 ...
 */
flatten<T: math$MathArray | math$Matrix>(x: T): T,
 ...
 */
forEach<T: math$Matrix | math$MathArray>(
x: T,
callback: (value: any, index: any, matrix: T) => void): void,
 ...
 */
inv<T: number | math$Complex | math$MathArray | math$Matrix>(
x: T): NoLiteralType<T>,
 ...
 */
map<T: math$Matrix | math$MathArray>(
x: T,
callback: (value: any, index: any, matrix: T) => math$MathType | string): T,
 ...
 */
reshape<T: math$MathArray | math$Matrix>(x: T, sizes: number[]): T,
 ...
 */
resize<T: math$MathArray | math$Matrix>(
x: T,
size: math$MathArray | math$Matrix,
defaultValue?: number | string): T,
 ...
 */
row<T: math$MathArray | math$Matrix>(value: T, row: number): T,
 ...
 */
column<T: math$MathArray | math$Matrix>(value: T, column: number): T,
 ...
 */
sort<T: math$Matrix | math$MathArray>(
x: T,
compare: ((a: any, b: any) => number) | "asc" | "desc" | "natural"): T,
 ...
 */
sqrtm<T: math$MathArray | math$Matrix>(A: T): T,
 ...
 */
squeeze<T: math$MathArray | math$Matrix>(x: T): T,
 ...
 */
subset<T: math$MathArray | math$Matrix | string>(
value: T,
index: math$Index,
replacement?: any,
defaultValue?: any): T,
 ...
 */
transpose<T: math$MathArray | math$Matrix>(x: T): T,
 ...
 */
combinations<T: number | math$BigNumber>(n: T, k: number | math$BigNumber): NoLiteralType<T>,
 ...
 */
factorial<T: number | math$BigNumber | math$MathArray | math$Matrix>(
n: T): NoLiteralType<T>,
 ...
 */
multinomial<T: number | math$BigNumber>(a: T[]): NoLiteralType<T>,
 ...
 */
permutations<T: number | math$BigNumber>(
n: T,
k?: number | math$BigNumber): NoLiteralType<T>,
...
random<T: math$MathArray | math$Matrix>(size: T, min?: number, max?: number): T,
...
randomInt<T: math$MathArray | math$Matrix>(size: T, min?: number, max?: number): T,
 ...
 */
setCartesian<T: math$MathArray | math$Matrix>(a1: T, a2: math$MathArray | math$Matrix): T,
 ...
 */
setDifference<T: math$MathArray | math$Matrix>(a1: T, a2: math$MathArray | math$Matrix): T,
 ...
 */
setDistinct<T: math$MathArray | math$Matrix>(a: T): T,
 ...
 */
setIntersect<T: math$MathArray | math$Matrix>(a1: T, a2: math$MathArray | math$Matrix): T,
 ...
 */
setPowerset<T: math$MathArray | math$Matrix>(a: T): T,
 ...
 */
setSymDifference<T: math$MathArray | math$Matrix>(a1: T, a2: math$MathArray | math$Matrix): T,
 ...
 */
setUnion<T: math$MathArray | math$Matrix>(a1: T, a2: math$MathArray | math$Matrix): T,
 ...
 */
erf<T: number | math$MathArray | math$Matrix>(x: T): NoLiteralType<T>,
 ...
 */
variance(...args: Array<number | math$BigNumber | math$Fraction>): any,
 ...
 * string.
 * @see http: /* NO PRINT IMPLEMENTED: JSDocNameReference */ any ://mathjs.org/docs/reference/functions/format.html
 ...
 * **********************************************************************
 */
declare interface math$FactoryDependencies {
create: (
factories: math$FactoryFunctionMap,
config?: math$ConfigOptions) => math$MathJsStatic,
factory: <T>(
name: string,
dependencies: math$MathJsFunctionName[],
create: (injected: $Rest<math$MathJsStatic, {...}>) => T,
meta?: any) => math$FactoryFunction<T>,
all: math$FactoryFunctionMap,
typedDependencies: math$FactoryFunctionMap,
ResultSetDependencies: math$FactoryFunctionMap,
BigNumberDependencies: math$FactoryFunctionMap,
ComplexDependencies: math$FactoryFunctionMap,
FractionDependencies: math$FactoryFunctionMap,
RangeDependencies: math$FactoryFunctionMap,
MatrixDependencies: math$FactoryFunctionMap,
DenseMatrixDependencies: math$FactoryFunctionMap,
cloneDependencies: math$FactoryFunctionMap,
isIntegerDependencies: math$FactoryFunctionMap,
isNegativeDependencies: math$FactoryFunctionMap,
isNumericDependencies: math$FactoryFunctionMap,
hasNumericValueDependencies: math$FactoryFunctionMap,
isPositiveDependencies: math$FactoryFunctionMap,
isZeroDependencies: math$FactoryFunctionMap,
isNaNDependencies: math$FactoryFunctionMap,
typeOfDependencies: math$FactoryFunctionMap,
typeofDependencies: math$FactoryFunctionMap,
equalScalarDependencies: math$FactoryFunctionMap,
SparseMatrixDependencies: math$FactoryFunctionMap,
numberDependencies: math$FactoryFunctionMap,
stringDependencies: math$FactoryFunctionMap,
booleanDependencies: math$FactoryFunctionMap,
bignumberDependencies: math$FactoryFunctionMap,
complexDependencies: math$FactoryFunctionMap,
fractionDependencies: math$FactoryFunctionMap,
matrixDependencies: math$FactoryFunctionMap,
splitUnitDependencies: math$FactoryFunctionMap,
unaryMinusDependencies: math$FactoryFunctionMap,
unaryPlusDependencies: math$FactoryFunctionMap,
absDependencies: math$FactoryFunctionMap,
applyDependencies: math$FactoryFunctionMap,
addScalarDependencies: math$FactoryFunctionMap,
cbrtDependencies: math$FactoryFunctionMap,
ceilDependencies: math$FactoryFunctionMap,
cubeDependencies: math$FactoryFunctionMap,
expDependencies: math$FactoryFunctionMap,
expm1Dependencies: math$FactoryFunctionMap,
fixDependencies: math$FactoryFunctionMap,
floorDependencies: math$FactoryFunctionMap,
gcdDependencies: math$FactoryFunctionMap,
lcmDependencies: math$FactoryFunctionMap,
log10Dependencies: math$FactoryFunctionMap,
log2Dependencies: math$FactoryFunctionMap,
modDependencies: math$FactoryFunctionMap,
multiplyScalarDependencies: math$FactoryFunctionMap,
multiplyDependencies: math$FactoryFunctionMap,
nthRootDependencies: math$FactoryFunctionMap,
signDependencies: math$FactoryFunctionMap,
sqrtDependencies: math$FactoryFunctionMap,
squareDependencies: math$FactoryFunctionMap,
subtractDependencies: math$FactoryFunctionMap,
xgcdDependencies: math$FactoryFunctionMap,
dotMultiplyDependencies: math$FactoryFunctionMap,
bitAndDependencies: math$FactoryFunctionMap,
bitNotDependencies: math$FactoryFunctionMap,
bitOrDependencies: math$FactoryFunctionMap,
bitXorDependencies: math$FactoryFunctionMap,
argDependencies: math$FactoryFunctionMap,
conjDependencies: math$FactoryFunctionMap,
imDependencies: math$FactoryFunctionMap,
reDependencies: math$FactoryFunctionMap,
notDependencies: math$FactoryFunctionMap,
orDependencies: math$FactoryFunctionMap,
xorDependencies: math$FactoryFunctionMap,
concatDependencies: math$FactoryFunctionMap,
columnDependencies: math$FactoryFunctionMap,
crossDependencies: math$FactoryFunctionMap,
diagDependencies: math$FactoryFunctionMap,
eyeDependencies: math$FactoryFunctionMap,
filterDependencies: math$FactoryFunctionMap,
flattenDependencies: math$FactoryFunctionMap,
forEachDependencies: math$FactoryFunctionMap,
getMatrixDataTypeDependencies: math$FactoryFunctionMap,
identityDependencies: math$FactoryFunctionMap,
kronDependencies: math$FactoryFunctionMap,
mapDependencies: math$FactoryFunctionMap,
onesDependencies: math$FactoryFunctionMap,
rangeDependencies: math$FactoryFunctionMap,
reshapeDependencies: math$FactoryFunctionMap,
resizeDependencies: math$FactoryFunctionMap,
rowDependencies: math$FactoryFunctionMap,
sizeDependencies: math$FactoryFunctionMap,
squeezeDependencies: math$FactoryFunctionMap,
subsetDependencies: math$FactoryFunctionMap,
transposeDependencies: math$FactoryFunctionMap,
ctransposeDependencies: math$FactoryFunctionMap,
zerosDependencies: math$FactoryFunctionMap,
erfDependencies: math$FactoryFunctionMap,
modeDependencies: math$FactoryFunctionMap,
prodDependencies: math$FactoryFunctionMap,
formatDependencies: math$FactoryFunctionMap,
printDependencies: math$FactoryFunctionMap,
toDependencies: math$FactoryFunctionMap,
isPrimeDependencies: math$FactoryFunctionMap,
numericDependencies: math$FactoryFunctionMap,
divideScalarDependencies: math$FactoryFunctionMap,
powDependencies: math$FactoryFunctionMap,
roundDependencies: math$FactoryFunctionMap,
logDependencies: math$FactoryFunctionMap,
log1pDependencies: math$FactoryFunctionMap,
nthRootsDependencies: math$FactoryFunctionMap,
dotPowDependencies: math$FactoryFunctionMap,
dotDivideDependencies: math$FactoryFunctionMap,
lsolveDependencies: math$FactoryFunctionMap,
usolveDependencies: math$FactoryFunctionMap,
leftShiftDependencies: math$FactoryFunctionMap,
rightArithShiftDependencies: math$FactoryFunctionMap,
rightLogShiftDependencies: math$FactoryFunctionMap,
andDependencies: math$FactoryFunctionMap,
compareDependencies: math$FactoryFunctionMap,
compareNaturalDependencies: math$FactoryFunctionMap,
compareTextDependencies: math$FactoryFunctionMap,
equalDependencies: math$FactoryFunctionMap,
equalTextDependencies: math$FactoryFunctionMap,
smallerDependencies: math$FactoryFunctionMap,
smallerEqDependencies: math$FactoryFunctionMap,
largerDependencies: math$FactoryFunctionMap,
largerEqDependencies: math$FactoryFunctionMap,
deepEqualDependencies: math$FactoryFunctionMap,
unequalDependencies: math$FactoryFunctionMap,
partitionSelectDependencies: math$FactoryFunctionMap,
sortDependencies: math$FactoryFunctionMap,
maxDependencies: math$FactoryFunctionMap,
minDependencies: math$FactoryFunctionMap,
ImmutableDenseMatrixDependencies: math$FactoryFunctionMap,
IndexDependencies: math$FactoryFunctionMap,
FibonacciHeapDependencies: math$FactoryFunctionMap,
SpaDependencies: math$FactoryFunctionMap,
UnitDependencies: math$FactoryFunctionMap,
unitDependencies: math$FactoryFunctionMap,
sparseDependencies: math$FactoryFunctionMap,
createUnitDependencies: math$FactoryFunctionMap,
acosDependencies: math$FactoryFunctionMap,
acoshDependencies: math$FactoryFunctionMap,
acotDependencies: math$FactoryFunctionMap,
acothDependencies: math$FactoryFunctionMap,
acscDependencies: math$FactoryFunctionMap,
acschDependencies: math$FactoryFunctionMap,
asecDependencies: math$FactoryFunctionMap,
asechDependencies: math$FactoryFunctionMap,
asinDependencies: math$FactoryFunctionMap,
asinhDependencies: math$FactoryFunctionMap,
atanDependencies: math$FactoryFunctionMap,
atan2Dependencies: math$FactoryFunctionMap,
atanhDependencies: math$FactoryFunctionMap,
cosDependencies: math$FactoryFunctionMap,
coshDependencies: math$FactoryFunctionMap,
cotDependencies: math$FactoryFunctionMap,
cothDependencies: math$FactoryFunctionMap,
cscDependencies: math$FactoryFunctionMap,
cschDependencies: math$FactoryFunctionMap,
secDependencies: math$FactoryFunctionMap,
sechDependencies: math$FactoryFunctionMap,
sinDependencies: math$FactoryFunctionMap,
sinhDependencies: math$FactoryFunctionMap,
tanDependencies: math$FactoryFunctionMap,
tanhDependencies: math$FactoryFunctionMap,
setCartesianDependencies: math$FactoryFunctionMap,
setDifferenceDependencies: math$FactoryFunctionMap,
setDistinctDependencies: math$FactoryFunctionMap,
setIntersectDependencies: math$FactoryFunctionMap,
setIsSubsetDependencies: math$FactoryFunctionMap,
setMultiplicityDependencies: math$FactoryFunctionMap,
setPowersetDependencies: math$FactoryFunctionMap,
setSizeDependencies: math$FactoryFunctionMap,
setSymDifferenceDependencies: math$FactoryFunctionMap,
setUnionDependencies: math$FactoryFunctionMap,
addDependencies: math$FactoryFunctionMap,
hypotDependencies: math$FactoryFunctionMap,
normDependencies: math$FactoryFunctionMap,
dotDependencies: math$FactoryFunctionMap,
traceDependencies: math$FactoryFunctionMap,
indexDependencies: math$FactoryFunctionMap,
NodeDependencies: math$FactoryFunctionMap,
AccessorNodeDependencies: math$FactoryFunctionMap,
ArrayNodeDependencies: math$FactoryFunctionMap,
AssignmentNodeDependencies: math$FactoryFunctionMap,
BlockNodeDependencies: math$FactoryFunctionMap,
ConditionalNodeDependencies: math$FactoryFunctionMap,
ConstantNodeDependencies: math$FactoryFunctionMap,
FunctionAssignmentNodeDependencies: math$FactoryFunctionMap,
IndexNodeDependencies: math$FactoryFunctionMap,
ObjectNodeDependencies: math$FactoryFunctionMap,
OperatorNodeDependencies: math$FactoryFunctionMap,
ParenthesisNodeDependencies: math$FactoryFunctionMap,
RangeNodeDependencies: math$FactoryFunctionMap,
RelationalNodeDependencies: math$FactoryFunctionMap,
SymbolNodeDependencies: math$FactoryFunctionMap,
FunctionNodeDependencies: math$FactoryFunctionMap,
parseDependencies: math$FactoryFunctionMap,
compileDependencies: math$FactoryFunctionMap,
evaluateDependencies: math$FactoryFunctionMap,
evalDependencies: math$FactoryFunctionMap,
ParserDependencies: math$FactoryFunctionMap,
parserDependencies: math$FactoryFunctionMap,
lupDependencies: math$FactoryFunctionMap,
qrDependencies: math$FactoryFunctionMap,
sluDependencies: math$FactoryFunctionMap,
lusolveDependencies: math$FactoryFunctionMap,
HelpDependencies: math$FactoryFunctionMap,
ChainDependencies: math$FactoryFunctionMap,
helpDependencies: math$FactoryFunctionMap,
chainDependencies: math$FactoryFunctionMap,
detDependencies: math$FactoryFunctionMap,
invDependencies: math$FactoryFunctionMap,
expmDependencies: math$FactoryFunctionMap,
sqrtmDependencies: math$FactoryFunctionMap,
divideDependencies: math$FactoryFunctionMap,
distanceDependencies: math$FactoryFunctionMap,
intersectDependencies: math$FactoryFunctionMap,
sumDependencies: math$FactoryFunctionMap,
meanDependencies: math$FactoryFunctionMap,
medianDependencies: math$FactoryFunctionMap,
madDependencies: math$FactoryFunctionMap,
varianceDependencies: math$FactoryFunctionMap,
varDependencies: math$FactoryFunctionMap,
quantileSeqDependencies: math$FactoryFunctionMap,
stdDependencies: math$FactoryFunctionMap,
combinationsDependencies: math$FactoryFunctionMap,
gammaDependencies: math$FactoryFunctionMap,
factorialDependencies: math$FactoryFunctionMap,
kldivergenceDependencies: math$FactoryFunctionMap,
multinomialDependencies: math$FactoryFunctionMap,
permutationsDependencies: math$FactoryFunctionMap,
pickRandomDependencies: math$FactoryFunctionMap,
randomDependencies: math$FactoryFunctionMap,
randomIntDependencies: math$FactoryFunctionMap,
stirlingS2Dependencies: math$FactoryFunctionMap,
bellNumbersDependencies: math$FactoryFunctionMap,
catalanDependencies: math$FactoryFunctionMap,
compositionDependencies: math$FactoryFunctionMap,
simplifyDependencies: math$FactoryFunctionMap,
derivativeDependencies: math$FactoryFunctionMap,
rationalizeDependencies: math$FactoryFunctionMap,
reviverDependencies: math$FactoryFunctionMap,
eDependencies: math$FactoryFunctionMap,
EDependencies: math$FactoryFunctionMap,
falseDependencies: math$FactoryFunctionMap,
iDependencies: math$FactoryFunctionMap,
InfinityDependencies: math$FactoryFunctionMap,
LN10Dependencies: math$FactoryFunctionMap,
LN2Dependencies: math$FactoryFunctionMap,
LOG10EDependencies: math$FactoryFunctionMap,
LOG2EDependencies: math$FactoryFunctionMap,
NaNDependencies: math$FactoryFunctionMap,
nullDependencies: math$FactoryFunctionMap,
phiDependencies: math$FactoryFunctionMap,
piDependencies: math$FactoryFunctionMap,
PIDependencies: math$FactoryFunctionMap,
SQRT1_2Dependencies: math$FactoryFunctionMap,
SQRT2Dependencies: math$FactoryFunctionMap,
tauDependencies: math$FactoryFunctionMap,
trueDependencies: math$FactoryFunctionMap,
versionDependencies: math$FactoryFunctionMap,
atomicMassDependencies: math$FactoryFunctionMap,
avogadroDependencies: math$FactoryFunctionMap,
bohrMagnetonDependencies: math$FactoryFunctionMap,
bohrRadiusDependencies: math$FactoryFunctionMap,
boltzmannDependencies: math$FactoryFunctionMap,
classicalElectronRadiusDependencies: math$FactoryFunctionMap,
conductanceQuantumDependencies: math$FactoryFunctionMap,
coulombDependencies: math$FactoryFunctionMap,
deuteronMassDependencies: math$FactoryFunctionMap,
efimovFactorDependencies: math$FactoryFunctionMap,
electricConstantDependencies: math$FactoryFunctionMap,
electronMassDependencies: math$FactoryFunctionMap,
elementaryChargeDependencies: math$FactoryFunctionMap,
faradayDependencies: math$FactoryFunctionMap,
fermiCouplingDependencies: math$FactoryFunctionMap,
fineStructureDependencies: math$FactoryFunctionMap,
firstRadiationDependencies: math$FactoryFunctionMap,
gasConstantDependencies: math$FactoryFunctionMap,
gravitationConstantDependencies: math$FactoryFunctionMap,
gravityDependencies: math$FactoryFunctionMap,
hartreeEnergyDependencies: math$FactoryFunctionMap,
inverseConductanceQuantumDependencies: math$FactoryFunctionMap,
klitzingDependencies: math$FactoryFunctionMap,
loschmidtDependencies: math$FactoryFunctionMap,
magneticConstantDependencies: math$FactoryFunctionMap,
magneticFluxQuantumDependencies: math$FactoryFunctionMap,
molarMassDependencies: math$FactoryFunctionMap,
molarMassC12Dependencies: math$FactoryFunctionMap,
molarPlanckConstantDependencies: math$FactoryFunctionMap,
molarVolumeDependencies: math$FactoryFunctionMap,
neutronMassDependencies: math$FactoryFunctionMap,
nuclearMagnetonDependencies: math$FactoryFunctionMap,
planckChargeDependencies: math$FactoryFunctionMap,
planckConstantDependencies: math$FactoryFunctionMap,
planckLengthDependencies: math$FactoryFunctionMap,
planckMassDependencies: math$FactoryFunctionMap,
planckTemperatureDependencies: math$FactoryFunctionMap,
planckTimeDependencies: math$FactoryFunctionMap,
protonMassDependencies: math$FactoryFunctionMap,
quantumOfCirculationDependencies: math$FactoryFunctionMap,
reducedPlanckConstantDependencies: math$FactoryFunctionMap,
rydbergDependencies: math$FactoryFunctionMap,
sackurTetrodeDependencies: math$FactoryFunctionMap,
secondRadiationDependencies: math$FactoryFunctionMap,
speedOfLightDependencies: math$FactoryFunctionMap,
stefanBoltzmannDependencies: math$FactoryFunctionMap,
thomsonCrossSectionDependencies: math$FactoryFunctionMap,
vacuumImpedanceDependencies: math$FactoryFunctionMap,
weakMixingAngleDependencies: math$FactoryFunctionMap,
wienDisplacementDependencies: math$FactoryFunctionMap,
applyTransformDependencies: math$FactoryFunctionMap,
columnTransformDependencies: math$FactoryFunctionMap,
filterTransformDependencies: math$FactoryFunctionMap,
forEachTransformDependencies: math$FactoryFunctionMap,
indexTransformDependencies: math$FactoryFunctionMap,
mapTransformDependencies: math$FactoryFunctionMap,
maxTransformDependencies: math$FactoryFunctionMap,
meanTransformDependencies: math$FactoryFunctionMap,
minTransformDependencies: math$FactoryFunctionMap,
rangeTransformDependencies: math$FactoryFunctionMap,
rowTransformDependencies: math$FactoryFunctionMap,
subsetTransformDependencies: math$FactoryFunctionMap,
concatTransformDependencies: math$FactoryFunctionMap,
stdTransformDependencies: math$FactoryFunctionMap,
sumTransformDependencies: math$FactoryFunctionMap,
varianceTransformDependencies: math$FactoryFunctionMap,
} 
...
apply(
dim: number,
callback: (array: math$MathArray | math$Matrix) => number): math$Matrix | math$MathArray,
...
toArray(): math$MathArray,
valueOf(): math$MathArray,
...
declare interface math$SimplifyOptions {
...
declare type math$SimplifyRule = {
l: string,
r: string,...
} | string | ((node: math$MathNode) => math$MathNode);

declare interface math$Simplify {
(expr: math$MathNode | string, rules?: math$SimplifyRule[], scope?: {[key: string]: any}, options?: math$SimplifyOptions): math$MathNode,
(expr: math$MathNode | string, scope?: {[key: string]: any}, options?: math$SimplifyOptions): math$MathNode,
rules: math$SimplifyRule[],
simplifyCore(expr: math$MathNode): math$MathNode,
} 
...
declare interface math$MathNodeCommon {
isNode: true,
comment: string,
type: "AccessorNode"
| "ArrayNode"
 ...
 * @param scope Scope to read/write variables
 */
evaluate(scope?: {[key: string]: any}): math$MathJsChain,
 ...
 */
simplify(rules?: math$SimplifyRule[], scope?: {[key: string]: any}): math$MathJsChain,
...
apply(
dim: number,
callback: (array: Array<math$MathType> | math$Matrix) => number): math$MathJsChain,
 ...
 * @param y The exponent
 */
pow(y: number | math$BigNumber): math$MathJsChain,
 ...
 * @returns The sign of x
 */
sign(x: number | math$BigNumber): math$MathJsChain,
 ...
 * @param format The Matrix storage format
 */
identity(format?: string): math$MathJsChain,

/**
 * @param n The y dimension for the matrix
 * @param format The Matrix storage format
 */
identity(n: number, format?: string): math$MathJsChain,

/**
 * Filter the items in an array or one dimensional matrix.
 */
filter(
test: ((value: any, index: any, matrix: math$Matrix | math$MathArray) => boolean) | RegExp): math$MathJsChain,
